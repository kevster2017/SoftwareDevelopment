namespace SoftwareDevelopment
{
    partial class PrimeNumberCode
    {
        ...
        private void InitializeComponent()
        {
            ...
            // vScrollBar1
            // 
            vScrollBar1.Location = new Point(972, 175);
            ...
            label8.Location = new Point(154, 418);
            label8.Name = "label8";
            ...
            btnBack.Location = new Point(434, 479);
            ...
            btnClear.Location = new Point(274, 479);
            ...
            btnDisplay.Location = new Point(124, 479);
            ...
            textBoxCode.Location = new Point(593, 175);
            ...
            label7.Location = new Point(154, 342);
            label7.Name = "label7";
            label7.Size = new Size(165, 18);
            label7.TabIndex = 30;
            label7.Text = "* Loop through number";
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label6.Location = new Point(154, 382);
            label6.Name = "label6";
            label6.Size = new Size(415, 18);
            label6.TabIndex = 29;
            label6.Text = "* Use modulus operator to determine if the number is prime";
            // 
            // label5
            // 
            label5.AutoSize = true;
            label5.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label5.Location = new Point(154, 304);
            label5.Name = "label5";
            label5.Size = new Size(185, 18);
            label5.TabIndex = 28;
            label5.Text = "* Check if the number is 2";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label4.Location = new Point(154, 270);
            label4.Name = "label4";
            label4.Size = new Size(216, 18);
            label4.TabIndex = 27;
            label4.Text = "* Check if the number is 0 or 1";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label3.Location = new Point(154, 233);
            label3.Name = "label3";
            ...
            label2.Location = new Point(121, 175);
            label2.Margin = new Padding(4, 0, 4, 0);
            label2.Name = "label2";
            label2.Size = new Size(265, 23);
            label2.TabIndex = 25;
            label2.Text = "How to determine a prime number";
            // 
            // label1
            // 
            ...
            Controls.Add(label2);
            Controls.Add(label1);
            Name = "PrimeNumberCode";
            Text = "PrimeNumberCode";
            ResumeLayout(false);
            PerformLayout();
        }
