namespace SoftwareDevelopment
{
    partial class LinkedListCode
    {
        ...
        private void InitializeComponent()
        {
            ...
            label7.Location = new Point(154, 366);
            label7.Name = "label7";
            label7.Size = new Size(433, 18);
            label7.TabIndex = 117;
            label7.Text = "* Foreach loop to loop through reversed list and display output";
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label6.Location = new Point(153, 291);
            label6.Name = "label6";
            label6.Size = new Size(337, 18);
            label6.TabIndex = 116;
            label6.Text = "* Create second list variable as a new linked list";
            // 
            // label5
            // 
            label5.AutoSize = true;
            label5.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label5.Location = new Point(154, 326);
            label5.Name = "label5";
            ...
            label8.Location = new Point(154, 257);
            label8.Name = "label8";
            label8.Size = new Size(368, 18);
            label8.TabIndex = 113;
            label8.Text = "* Foreach loop to loop through list and display output";
            // 
            // btnBack
            // 
            btnBack.BackColor = Color.Red;
            btnBack.Font = new Font("Arial Narrow", 14.25F, FontStyle.Bold, GraphicsUnit.Point);
            btnBack.Location = new Point(433, 486);
            ...
            btnClear.Location = new Point(273, 486);
            ...
            btnDisplay.Location = new Point(123, 486);
            ...
            label4.Location = new Point(153, 186);
            label4.Name = "label4";
            label4.Size = new Size(192, 18);
            label4.TabIndex = 108;
            label4.Text = "* Create Linked List object";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label3.Location = new Point(153, 221);
            label3.Name = "label3";
            label3.Size = new Size(202, 18);
            label3.TabIndex = 107;
            label3.Text = "* Add user input to linked list";
            // 
            // label2
            // 
            ...
            label2.TabIndex = 106;
            label2.Text = "How to reverse Linked List";
            // 
            // label1
            // 
            ...
            label1.TabIndex = 105;
            label1.Text = "How to reverse a Linked List";
            // 
            // LinkedListCode
            // 
