...
{
    partial class BinarySearchCode
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label7.Location = new Point(205, 316);
            label7.Name = "label7";
            label7.Size = new Size(337, 18);
            label7.TabIndex = 130;
            label7.Text = "* Else if mid less than target, low equals mid + 1";
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label6.Location = new Point(205, 261);
            label6.Name = "label6";
            label6.Size = new Size(155, 18);
            label6.TabIndex = 129;
            label6.Text = "* Create mid variable";
            // 
            // label5
            // 
            label5.AutoSize = true;
            label5.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label5.Location = new Point(205, 288);
            label5.Name = "label5";
            ...
            label8.Location = new Point(205, 231);
            label8.Name = "label8";
            label8.Size = new Size(260, 18);
            label8.TabIndex = 126;
            label8.Text = "* Create while loop while low <= high";
            // 
            // btnBack
            // 
            btnBack.BackColor = Color.Red;
            btnBack.Font = new Font("Arial Narrow", 14.25F, FontStyle.Bold, GraphicsUnit.Point);
            btnBack.Location = new Point(484, 493);
            btnBack.Name = "btnBack";
            btnBack.Size = new Size(118, 40);
            btnBack.TabIndex = 125;
            btnBack.Text = "Back";
            ...
            btnClear.Location = new Point(324, 493);
            ...
            btnDisplay.Location = new Point(174, 493);
            btnDisplay.Name = "btnDisplay";
            btnDisplay.Size = new Size(118, 40);
            btnDisplay.TabIndex = 123;
            ...
            label4.Name = "label4";
            label4.Size = new Size(461, 18);
            label4.TabIndex = 121;
            label4.Text = "* Create Search function that takes two parameters: arr and target";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label3.Location = new Point(205, 204);
            label3.Name = "label3";
            label3.Size = new Size(271, 18);
            label3.TabIndex = 120;
            label3.Text = "* Create two int variables low and high";
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Font = new Font("Arial Narrow", 14.25F, FontStyle.Bold, GraphicsUnit.Point);
            label2.Location = new Point(171, 137);
            label2.Margin = new Padding(4, 0, 4, 0);
            label2.Name = "label2";
            label2.Size = new Size(255, 23);
            label2.TabIndex = 119;
            label2.Text = "How to implement Binary Search";
            // 
            // label1
            // 
            label1.AutoSize = true;
            label1.Font = new Font("Showcard Gothic", 14.25F, FontStyle.Bold, GraphicsUnit.Point);
            label1.Location = new Point(388, 74);
            label1.Margin = new Padding(4, 0, 4, 0);
            label1.Name = "label1";
            label1.Size = new Size(381, 23);
            label1.TabIndex = 118;
            label1.Text = "How to implement Binary Search";
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label9.Location = new Point(205, 465);
            label9.Name = "label9";
            label9.Size = new Size(119, 18);
            label9.TabIndex = 131;
            label9.Text = "* Display results";
            // 
            // label10
            // 
            label10.AutoSize = true;
            label10.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label10.Location = new Point(205, 370);
            label10.Name = "label10";
            label10.Size = new Size(164, 18);
            label10.TabIndex = 132;
            label10.Text = "* Return - 1 if not found";
            // 
            // label11
            // 
            label11.AutoSize = true;
            label11.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label11.Location = new Point(205, 343);
            label11.Name = "label11";
            label11.Size = new Size(184, 18);
            label11.TabIndex = 133;
            label11.Text = "* Else high equals mid - 1";
            // 
            // label12
            // 
            label12.AutoSize = true;
            label12.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label12.Location = new Point(174, 397);
            label12.Name = "label12";
            label12.Size = new Size(175, 18);
            label12.TabIndex = 134;
            label12.Text = "* Declare then sort array";
            // 
            // label13
            // 
            label13.AutoSize = true;
            label13.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label13.Location = new Point(205, 415);
            label13.Name = "label13";
            label13.Size = new Size(310, 18);
            label13.TabIndex = 135;
            label13.Text = "* Create int variable target, set as user input";
            // 
            // label14
            // 
            label14.AutoSize = true;
            label14.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            label14.Location = new Point(205, 433);
            label14.Name = "label14";
            label14.Size = new Size(327, 18);
            label14.TabIndex = 136;
            label14.Text = "* Create result var, set as Search(array, target)";
            // 
            // BinarySearchCode
            // 
            ...
            Controls.Add(label2);
            Controls.Add(label1);
            Name = "BinarySearchCode";
            Text = "BinarySearchCode";
            ResumeLayout(false);
            PerformLayout();
        }
